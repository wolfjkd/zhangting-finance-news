...
if exist "dist\涨停财经聚合播报_v3.9.9.exe" (
    echo   删除旧 exe...
    del /q "dist\涨停财经聚合播报_v3.9.9.exe"
  )
echo   OK: 旧构建已清理
...
if exist "dist\涨停财经聚合播报_v3.9.9.exe" (
    echo.
    echo [4/4] exe 文件已生成: dist\涨停财经聚合播报_v3.9.9.exe
  ) else (
    echo.
...
echo ==========================================
echo.
echo  输出文件: dist\涨停财经聚合播报_v3.9.9.exe
echo.
echo  按任意键退出...
pause >nul
